 ...
 *
 */
public class BottomPanelChangeAction extends AbstractAction
{
	...
	static {
		requests.put(new Integer(Concept.KEY), ApplicationManager.Request.CHANGE_BOTTOM_CONTENT_CONCEPTS);
		requests.put(new Integer(Lemma.KEY), ApplicationManager.Request.CHANGE_BOTTOM_CONTENT_LEMMAS);
		requests.put(new Integer(DocumentPart.KEY), ApplicationManager.Request.CHANGE_BOTTOM_CONTENT_DOCUMENTS);
     ...
     * @throws Exception
     */
    public BottomPanelChangeAction(int categoryKey) throws Exception
    {
	 ...
	 */
    public BottomPanelChangeAction(String label, String icon, ApplicationManager.Request request) throws Exception
    {
	 ...
	 * @throws Exception The keystroke invoking this action. 
	 */
	public BottomPanelChangeAction(String label, String icon, ApplicationManager.Request request, KeyStroke keystroke) throws Exception                                
	{
