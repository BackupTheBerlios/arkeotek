 ...
 *
 */
public class SCDIndexationAction extends AbstractAction
{
	/**
     ...
     * @throws Exception
     */
    public SCDIndexationAction() throws Exception
    {
		this(DEFAULT_LABEL, DEFAULT_ICON, ApplicationManager.Request.SCD_INDEXATION);
    }
	 ...
	 */
    public SCDIndexationAction(String label, String icon, ApplicationManager.Request request) throws Exception
    {
	 ...
	 * @throws Exception The keystroke invoking this action. 
	 */
	public SCDIndexationAction(String label, String icon, ApplicationManager.Request request, KeyStroke keystroke) throws Exception                                
	{
