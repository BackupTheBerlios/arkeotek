...
public class Transaction
{
	...
	private void getConnexionFactory(IService caller)
	{
		try {
			...
			catch (SQLException e){ System.err.println("echec connection � la bdd: "+e);}
	...
	public void deconnexion() 
	{
		...
		{
			//throw new SystemException("Probl�me d�connexion base de donn�es");
		}
	}
	 ...
	 * @throws SystemException exception syst�me
	 */
	public void clean(ResultSet rset, Statement stmt) {
		...
		{
			//throw new SystemException("Probl�me fermeture");
		}
	}
