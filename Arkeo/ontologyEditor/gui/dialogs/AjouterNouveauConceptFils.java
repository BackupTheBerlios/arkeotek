...
public class AjouterNouveauConceptFils extends JDialog implements ActionListener {
	...
	public AjouterNouveauConceptFils(LinkableElement concept)
	{
	 ...
	 */
	private AjouterNouveauConceptFils(JFrame frame,LinkableElement concept)
	{
		...
		this.search_button.addMouseListener(new MouseAdapter()
		{
			...
			{
				AjouterNouveauConceptFils.this.validateInput();
			}
		});
		...
		this.cancel_button.addMouseListener(new MouseAdapter()
				{
					...
					public void mouseClicked(MouseEvent e)
					{
						AjouterNouveauConceptFils.this.cancelInput();
					}
				});
