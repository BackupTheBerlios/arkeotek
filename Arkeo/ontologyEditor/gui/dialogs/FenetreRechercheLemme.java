 ...
 *
 */
public class FenetreRechercheLemme extends JDialog  implements ActionListener, PropertyChangeListener
{
	 ...
	 */
	private FenetreRechercheLemme(JFrame frame)
	{
		...
		this.search_button.addMouseListener(new MouseAdapter()
		{
			...
			{
				FenetreRechercheLemme.this.validateInput();
			}
		});
		...
		this.cancel_button.addMouseListener(new MouseAdapter()
				{
					...
					public void mouseClicked(MouseEvent e)
					{
						FenetreRechercheLemme.this.cancelInput();
					}
				});
