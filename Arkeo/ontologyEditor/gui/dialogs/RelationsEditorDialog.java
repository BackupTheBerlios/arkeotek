 ...
 *
 */
public class RelationsEditorDialog extends JDialog  implements ActionListener, PropertyChangeListener
{
...
/**
    * @see java.awt.event.ActionListener#actionPerformed(java.awt.event.ActionEvent)
	...
	private void validateInput()
	{
		...
		if (this.cmb_storage_type.getSelectedIndex() == 0) {
			if (this.txt_storage_repository.equals(""))
		...
		if (!err_msg.equals("")) {
			...
			try {
				EncryptedProperties.createPropertiesFile(
						...
						((StorageCell) this.cmb_storage_type.getSelectedItem()).getDriver(), 
				...
				Object[] options = {"OK"};
				JOptionPane.showOptionDialog(this, "Une erreur interne est survenue lors de la création du fichier ./" + Constants.DEFAULT_ONTOLOGIES_PATH  + this.txt_ontology_name.getText() + ".properties", "Erreur de sauvegarde", JOptionPane.OK_OPTION, JOptionPane.ERROR_MESSAGE, null, options, options[0]);
				e.printStackTrace();
			} catch (InvalidKeySpecException e)
			{
				Object[] options = {"OK"};
				JOptionPane.showOptionDialog(this, "Une erreur interne est survenue lors du cryptage du mot de passe : spécification de clef invalide. ", "Erreur de sauvegarde", JOptionPane.OK_OPTION, JOptionPane.ERROR_MESSAGE, null, options, options[0]);
				e.printStackTrace();
